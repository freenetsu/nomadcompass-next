...
const MOCK_COUNTRIES: Country[] = [
  ...
  { id: "indonesie", name: "Indonésie (Bali)", flag: "🇮🇩", code: "ID" },
  { id: "vietnam", name: "Vietnam", flag: "🇻🇳", code: "VN" },
  { id: "colombie", name: "Colombie", flag: "🇨🇴", code: "CO" },
  { id: "costa-rica", name: "Costa Rica", flag: "🇨🇷", code: "CR" },
  { id: "malaisie", name: "Malaisie", flag: "🇲🇾", code: "MY" },
  { id: "roumanie", name: "Roumanie", flag: "🇷🇴", code: "RO" },
  { id: "bulgarie", name: "Bulgarie", flag: "🇧🇬", code: "BG" },
  { id: "turquie", name: "Turquie", flag: "🇹🇷", code: "TR" },
  { id: "argentine", name: "Argentine", flag: "🇦🇷", code: "AR" },
  { id: "maroc", name: "Maroc", flag: "🇲🇦", code: "MA" },
  { id: "emirats", name: "Émirats Arabes Unis", flag: "🇦🇪", code: "AE" },
  { id: "croatie", name: "Croatie", flag: "🇭🇷", code: "HR" },
  { id: "pologne", name: "Pologne", flag: "🇵🇱", code: "PL" },
  { id: "republique-tcheque", name: "République Tchèque", flag: "🇨🇿", code: "CZ" },
  { id: "hongrie", name: "Hongrie", flag: "🇭🇺", code: "HU" },
  { id: "italie", name: "Italie", flag: "🇮🇹", code: "IT" },
  { id: "philippines", name: "Philippines", flag: "🇵🇭", code: "PH" },
  { id: "bresil", name: "Brésil", flag: "🇧🇷", code: "BR" },
  { id: "chili", name: "Chili", flag: "🇨🇱", code: "CL" },
  { id: "perou", name: "Pérou", flag: "🇵🇪", code: "PE" },
];
