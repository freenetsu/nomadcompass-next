      ...
      <div className="relative">
        <textarea
          ...
          className={cn(
            ...
            disabled &&
              "bg-gray-100 opacity-50 text-gray-500 border-gray-300 cursor-not-allowed dark:bg-gray-800 dark:text-gray-300 dark:border-gray-700",
            error &&
              !disabled &&
        ...
        {hint && (
          <p
            className={cn(
              "mt-2 text-sm",
              error ? "text-error-500" : "text-gray-500 dark:text-gray-300",
            )}
          >
            {hint}
          </p>
