    ...
    <div className="rounded-2xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-white/[0.03] sm:p-8">
      ...
      <div className="flex flex-col gap-4 sm:hidden">
        <div className="flex items-start justify-between">
          <div className="flex items-center gap-3">
            <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-gray-100 text-4xl dark:bg-gray-800">
              {flag}
            </div>
            <div>
            ...
            <button
              ...
              className={`flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-xl border-2 transition-colors ${
                isFavorite
                  ...
                  : "border-gray-200 text-gray-400 hover:border-error-300 hover:text-error-500 dark:border-gray-700"
              }`}
            >
              <Heart
      ...
      <div className="hidden sm:flex sm:items-start sm:justify-between">
        <div className="flex items-center gap-6">
          <div className="flex h-24 w-24 items-center justify-center rounded-2xl bg-gray-100 text-6xl dark:bg-gray-800">
            {flag}
          </div>
          <div>
            <div className="flex items-center gap-3">
