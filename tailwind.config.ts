  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        ...
        "gradient-travel": "linear-gradient(135deg, #FF8000 0%, #00BCD4 100%)",
        "gradient-sunset": "linear-gradient(135deg, #FF8000 0%, #FFC107 100%)",
        "gradient-ocean": "linear-gradient(135deg, #00BCD4 0%, #9C27B0 100%)",
      },
      animation: {
